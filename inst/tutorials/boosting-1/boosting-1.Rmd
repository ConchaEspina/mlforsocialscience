...
```{r}
set.seed(744)
ada <- train(D_LSD ~ Age + Gender + Education + Nscore + Escore +
...
```{r}
set.seed(744)
gbm <- train(D_LSD ~ Age + Gender + Education + Nscore + Escore +
             Oscore + Ascore + Cscore + Impulsive + SS,
             data = drugs_train,
             method = "gbm",
             trControl = ctrl,
...
```{r}
set.seed(744)
cart <- train(D_LSD ~ Age + Gender + Education + Nscore + Escore +
             Oscore + Ascore + Cscore + Impulsive + SS,
              data = drugs_train,
              method = "rpart2",
              trControl = ctrl,
...
```{r}
set.seed(744)
logit <- train(D_LSD ~ Age + Gender + Education + Nscore + Escore +
             Oscore + Ascore + Cscore + Impulsive + SS,
             data = drugs_train,
             method = "glm",
             trControl = ctrl)
